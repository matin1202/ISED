...
// Servo adjustment
#define _DUTY_MAX 2353  // Servo angle: D degree
#define _DUTY_NEU 1530  // Servo angle: 0 degree
#define _DUTY_MIN 583   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 197 // Replace with |D - E| degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 632 - 2 * a_value  + 1.58 * pow(10, -3) * pow(a_value, 2);
}
